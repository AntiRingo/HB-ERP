...
@WebServlet("/fileFinAttributeCodeServlet/*")
public class FileFinAttributeCodeServlet extends HttpServlet {
                                                ...
                                                for (int z = 0; z < columns; z++) {
                                                    ...
                                                    if (sx.equals("属性"+k)){
                                                        ...
                                                        if (excelAttributeName.length()>0){
                                                            ...
                                                            List<FinAttributeName> attributeNames = finAttributeService.selectNameIdExcel(excelAttributeName, 0);
                                                            ...
                                                            if (attributeNames.size()>0 && excelAttributeLength.length()>0){
                                                                //该属性存在，查询长度
                                                                int length = attributeNames.get(0).getFinAttLength();
                                                                ...
                                                                if (length == Integer.parseInt(excelAttributeLength)){
                                                                    ...
                                                                    if (length==0){
                                                                        ...
                                                                        List<Map<String, Object>> maps = finMappingService.selectLength(id1);
                                                                        ...
                                                                        if (maps.size()>0){
                                                                            ...
                                                                            finAttributeService.updateLength(Integer.parseInt(excelAttributeLength),id1);
                                                                            exist=true;
                                                                ...
                                                                List<FinAttributeFunction> attributeFunctions = finAttributeFunctionService.selectByAttNameId(id1);
...
//                                                                System.out.println("属性值："+trim2+"编码"+trim3);
                                                                        ...
                                                                        for (int m = 1; m < rows; m++) {
                                                                            ...
                                                                            if (trim2.length()>0 && trim3.length()>0 ){
                                                                                if (l!=m){
                                                                                    ...
                                                                                    if (trim3.length()==attributeNames.get(0).getFinAttLength() || trim3.length()== Integer.parseInt(excelAttributeLength)){
                                                                                        //长度符合
                                                                        ...
                                                                        object.put("finAttValue",trim2);
                                                                        //查询该属性信息是否存在
                                                                        String s = JSON.toJSONString(object);
                                                                        FinAttributeValue attributeValue = JSON.parseObject(s, FinAttributeValue.class);
                                                                        boolean b = finAttributeValueService.selectValueExistAdd(attributeValue);
                                                                        boolean b1 = finAttributeValueService.selectCodeExistAdd(attributeValue);
                                                                        ...
                                                                        if (!b && !b1 && trim3.length()>0 && trim2.length()>0){
                                                                            ...
                                                                            if (excelAttributeRange){
                                                                                ...
                                                                                //查询该属性下的属性编码信息
                                                                                List<FinAttributeValue> attributeValues = finAttributeValueService.selectByAttNameId(attributeValue.getFinAttNameId());
                                                                                if (attributeValues.size()>0){
                                                                                    for (int j = 0; j < attributeValues.size(); j++) {
                                                                                        FinAttributeValue attributeValue1 = attributeValues.get(j);
                                                                                        String attValue = attributeValue1.getFinAttValue();//从数据库获取的数据
                                                                                        ...
                                                                                        if (b2){
                                                                                            ...
                                                                                            pass=false;
                                                                                            response.setContentType("text/json;charset=utf-8");
                                                                                            response.getWriter().write("在表  "+name+"  中,属性：  "+excelAttributeName+"  的属性值:  "+attributeValue.getFinAttValue()+"  在数据库与数据库中的属性值：  "+attValue+"   范围重叠！");
                                                                                            FileUtil.delFile(filePath);
                                                                            ...
                                                                            pass=false;
                                                                            response.setContentType("text/json;charset=utf-8");
                                                                            response.getWriter().write("在表  "+name+"  中,属性：  "+excelAttributeName+"  的属性值:  "+attributeValue.getFinAttValue()+"  在数据库中已存在！");
                                                                            FileUtil.delFile(filePath);
                                            ...
                                            String substring = name.substring(0, length0);
                                            //查询一级分类是否存在
                                            List<FinSort> sorts = finSortService.selectByCode(1,substring,0);
                                            if (sorts.size()>0){
                                                //存在该分类，获取分类id
                                                ...
                                                for (int k = 0; k < i1; k++) {
                                                    if (k==0){
                                                        ...
                                                        //获取二级分类的编码
                                                        String substring1 = name.substring(length0, length0+length1);
                                                        //根据编码查询分类id
                                                        List<FinSort> sorts1 = finSortService.selectByCode(2, substring1, oneSortId);
                                                        if (sorts1.size()>0){
                                                        ...
                                                        //获取三级分类编码
                                                        String substring1 = name.substring(length0+length1, length0+length1+length2);
                                                        //根据编码查询分类id
                                                        List<FinSort> sorts1 = finSortService.selectByCode(3, substring1, twoSortId);
                                                        ...
                                                        //获取四级分类编码
                                                        String substring1 = name.substring(length0+length1+length2,length0+length1+length2+length3);
                                                        //根据编码查询分类id
                                                        List<FinSort> sorts1 = finSortService.selectByCode(4, substring1, threeSortId);
                                                        if (sorts1.size()>0){
                                                ...
                                                for (int k = 1; k <= i2; k++) {
                                                    for (int z = 0; z <columns ; z++) {
                                                        ...
                                                        if (sx.equals("属性"+k)){
                                                            ...
                                                            if (excelAttributeName.length()>0){
                                                                int sortId = 0;
                                                                if (name.length()==length0){
                                                                    sortId = oneSortId;
                                                                }
                                                                else if (name.length()==(length0+length1)){
                                                                    sortId = twoSortId;
                                                                }
                                                                else if (name.length()==(length0+length1+length2)){
                                                                    sortId = threeSortId;
                                                                }
                                                                else if (name.length()==(length0+length1+length2+length3)){
                                                                    sortId = fourSortId;
                                                                }

                                                                List<FinAttributeName> attributeNames = finAttributeService.selectNameIdExcel(excelAttributeName, sortId);
                                                                ...
                                                                if (attributeNames.size()>0 && excelAttributeLength.length()>0){
                                                                    //该属性存在，查询长度
//                                                                    if (attributeNames.get(0).getFinAttLength() == null){
//                                                                        attributeNames.get(0).setFinAttLength(0);
//                                                                    }
                                                                    int length = attributeNames.get(0).getFinAttLength();
                                                                    ...
                                                                    if (length == Integer.parseInt(excelAttributeLength)){
                                                                        ...
                                                                        if (length==0){
                                                                            ...
                                                                            if (maps.size()>0){
                                                                                ...
                                                                                Object lengthMap = map.get("length");

                                                                                if (lengthMap.equals(Integer.parseInt(excelAttributeLength))){
                                                                                    //如果相同
                                                                                    exist=true;
                                                                                }
                                                                                else {
...
//
                                    ...
                                    List<FinAttributeFunction> attributeFunctions = JSONArray.parseArray(s, FinAttributeFunction.class);
                                    ...
                                    if (attributeFunctions.size()>0){
                                        for (int i = 0; i < attributeFunctions.size(); i++) {
                                            FinAttributeFunction attributeFunction = attributeFunctions.get(i);
                                            int attNameId = attributeFunction.getFinAttNameId();
                                            //根据属性id查询该属性下是否存在编码信息
                                            boolean b = finAttributeValueService.selectIfCode(attNameId);

                                            if (b){
                                                //如果存在编码，查询该function是否与excel里的一致，如果不一致报警

                                                //查询数据库中的function
                                                List<FinAttributeFunction> attributeFunctions1 = finAttributeFunctionService.selectByAttNameId(attNameId);
                                                FinAttributeFunction attributeFunction1 = attributeFunctions1.get(0);
                                                ...
                                                if (range!=range1){
                                                    //查询该属性信息
                                                    List<FinAttributeName> attributeNames = finAttributeService.selectById(attNameId);
                                                    String name = attributeNames.get(0).getFinAttName();
                                                    //查询该属性所在的分类
                                                    int parentId = attributeNames.get(0).getFinSortId();
                                                    List<FinSort> sorts = finSortService.selectSortById(parentId);
                                                    String name1 = sorts.get(0).getFinSortName();
                                    ...
                                    if (attributeFunctions.size()>0){
                                        for (int i = 0; i < attributeFunctions.size(); i++) {
                                            ...
                                            finAttributeFunctionService.update(attributeFunction);
                                    ...
                                    List<FinAttributeValue> attributeValues = JSONArray.parseArray(s1, FinAttributeValue.class);


                                    //修改function还要查询是否有物料信息
                                    if (attributeValues.size()>0){
                                        finAttributeValueService.addCodeAuto(attributeValues);
