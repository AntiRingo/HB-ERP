...
@WebServlet("/fileFinProductSortAndFinMappingServlet/*")
public class FileFinProductSortAndFinMappingServlet extends HttpServlet {
                                    ...
                                    for (int i = 0; i < sheets.length; i++) {
                                        ...
                                        if (sheetsName.equals("公共属性表")){
                                            ...
                                            if (!bhExist || !sxExist || !dwExist){
                                                ...
                                                for (int j = 1; j < rows; j++) {
                                                    ...
                                                    if (length>0&&length1>0){
                                                        ...
                                                        object.put("id","");
                                                        object.put("finSortId", 0);
                                                        object.put("finAttName",cell.getContents().trim());
                                                        object.put("finAttUnit",cell2.getContents().trim());
                                                        object.put("finAttLength","");
                                                        object.put("finAttPublic", 1);
                                            ...
                                            if (!sortCodeColumnsExist || !sortNameColumnsExist){
                                                ...
                                                for (int j = 1; j < rows; j++) {
                                                    ...
                                                    if (sortCode.length()==0 || sortName.length()==0){
                                                        ...
                                                        //判断分类码的长度是否符合要求
                                                        List<FinCode> codes = finCodeService.selectCode(1);
                                                        ...
                                                        object.put("finSortName",sortName);
                                                        object.put("finSortLevel",1);
                                                        object.put("finSortCode",sortCode);
                                                        object.put("vault",1);
                                                            ...
                                                            for (int k = 0; k < columns; k++) {
                                                                ...
                                                                if (trim.equals("属性"+l)){
                                                                    ...
                                                                    if (oneLevelAttributeName.length()>0){
                                                                        ...
                                                                        object1.put("id","");
                                                                        object1.put("finSortId","");
                                                                        object1.put("finAttName",oneLevelAttributeName);
                                                                        object1.put("finAttLength","");
                                                                        object1.put("finAttPublic","0");
                                                                        object1.put("finSortCode", parentId);
                                                                        ...
                                                                        if (trim1.equals("单位")){
                                                                            ...
                                                                            object1.put("finAttUnit",oneLevelAttributeNameUnit);
                                                                        }
                                                                        else {
                                                                            object1.put("finAttUnit","");
                                                                        }
                                            ...
                                            if (!sortCodeColumnsExist || !sortNameColumnsExist){
                                                ...
                                                for (int j = 1; j < rows; j++) {
                                                    ...
                                                    if (sortCode.length()==0 || sortName.length()==0){
                                                        ...
                                                        //判断分类码的长度是否符合要求
                                                        List<FinCode> codes = finCodeService.selectCode(1);
                                                        List<FinCode> codes1 = finCodeService.selectCode(2);
                                                        int length0 = codes.get(0).getLength();
                                                        int length1 = codes1.get(0).getLength();
                                                        int lengthSum=length1+length0;
                                                        ...
                                                        String code = sortCode.substring(length0,length0+length1);//本级（二级）编码
                                                        String oneLevelCode  = sortCode.substring(0, length0);//上级（一级）编码
                                                        ...
                                                        object.put("parentId", "");
                                                        object.put("finSortName",sortName);
                                                        object.put("finSortLevel",2);
                                                        object.put("finSortCode",code);
                                                        object.put("vault",1);
                                                ...
                                                for (int j = 0; j < twoLevelAttribute.size(); j++) {
                                                    ...
                                                    for (int k = 0; k < oneLevelAttribute.size(); k++) {
                                                        ...
                                                        Object code = o1.get("finSortCode");
                                                        if (oneLevelCode.equals(code)){
                                                            //编码相同，获取属性信息，对比是否重复
                                                            Object name = o1.get("finAttName");
                                                            Object name1 = o.get("finAttName");
                                            ...
                                            if (!sortCodeColumnsExist || !sortNameColumnsExist){
                                                ...
                                                for (int j = 1; j < rows; j++) {
                                                    ...
                                                    if (sortCode.length()==0 || sortName.length()==0){
                                                        ...
                                                        List<FinCode> codes =  finCodeService.selectCode(1);
                                                        List<FinCode> codes1 = finCodeService.selectCode(2);
                                                        List<FinCode> codes2 = finCodeService.selectCode(3);
                                                        int length0 = codes.get(0).getLength();
                                                        int length1 = codes1.get(0).getLength();
                                                        int length2 = codes2.get(0).getLength();
                                                        int lengthSum=length1+length0+length2;
                                                        if (lengthSum !=sortCode.length()){
                                                            response.setContentType("text/json;charset=utf-8");
                                                            response.getWriter().write("在表  "+sheetsName+"  中，分类码：  "+sortCode+"  的长度与设置不符合！");
                                                            FileUtil.delFile(filePath);
                                                        ...
                                                        String code = sortCode.substring(length0+length1,length0+length1+length2);//本级（三级）编码
                                                        String twoLevelCode = sortCode.substring(length0, length0+length1);//二级编码
                                                        String oneLevelCode  = sortCode.substring(0, length0);//上级（一级）编码
                                                ...
                                                for (int j = 0; j < threeLevelAttribute.size(); j++) {
                                                    ...
                                                    Object code1 = o.get("finSortCode");
                                                    for (int k = 0; k < oneLevelAttribute.size(); k++) {
                                                        JSONObject o1 = (JSONObject) oneLevelAttribute.get(k);
                                                        Object code = o1.get("finSortCode");
                                                        if (oneLevelCode.equals(code)){
                                            ...
                                            if (!sortCodeColumnsExist || !sortNameColumnsExist){
                                                ...
                                                for (int j = 1; j < rows; j++) {
                                                    ...
                                                    if (sortCode.length()==0 || sortName.length()==0){
                                                        ...
                                                        List<FinCode> codes1 = finCodeService.selectCode(2);
                                                        List<FinCode> codes2 = finCodeService.selectCode(3);
                                                        List<FinCode> codes3 = finCodeService.selectCode(4);
                                                        int length = codes.get(0).getLength();
                                                        int length1 = codes1.get(0).getLength();
                                                        int length2 = codes2.get(0).getLength();
                                                        ...
                                                        String code = sortCode.substring(length+length1+length2,length+length1+length2+length3);//本级（四级）编码
                                                        String threeLevelCode = sortCode.substring(length+length1, length+length1+length2);//三级编码
                                                        String twoLevelCode = sortCode.substring(length, length+length1);//二级编码
                                                        String oneLevelCode  = sortCode.substring(0, length);//上级（一级）编码
                                                ...
                                                for (int j = 0; j < fourLevelAttribute.size(); j++) {
                                                    ...
                                                    for (int k = 0; k < twoLevelAttribute.size(); k++) {
                                                        JSONObject o1 = (JSONObject) twoLevelAttribute.get(k);
                                                        Object code = o1.get("finSortCode");//二级编码
                                                        Object oneLevelCode1 = o1.get("oneLevelCode");
                                                        if (oneLevelCode.equals(oneLevelCode1) && twoLevelCode.equals(code)){
                                                            //编码相同，获取属性信息，对比是否重复
                                                            Object name = o1.get("finAttName");
                                                ...
                                                if (trim.length()>0){
                                                    ...
                                                    for (int k = 0; k < sheets.length; k++) {
                                                        ...
                                                        if (name.equals("一级属性表")){
                                                                    ...
                                                                    if (sx.equals("属性"+z)){
                                                                        ...
                                                                        if (trim1.length()>0 && trim2.length()>0 && trim3.length()>0){
                                                                            ...
                                                                            for (int l = 0; l < oneLevelAttribute.size(); l++) {
                                                                                ...
                                                                                Object code = object.get("finSortCode");//分类码
                                                                                if (code.equals(trim3)){
                                                                                    //分类码相同，对比属性是否存在
                                                                                    Object name1 = object.get("name");
                                                                                    if (name1.equals(trim2)){
                                                                                        //查询该属性的长度是不是没有
                                                                                        Object length = object.get("finAttLength");
                                                                                        if (length.equals("")){
                                                                                            object.put("finAttLength",trim1);
                                                                                            object.toJSONString();
                                                                                        }
                                                                                        exist=true;
                                                                                    }
                                                                            ...
                                                                            if (!exist){
                                                                                ...
                                                                                for (int l = 0; l < publicAttribute.size(); l++) {
                                                                                    ...
                                                                                    Object name1 = object.get("finAttName");
                                                                                    if (name1.equals(trim2)){
                                                                                        //查询该属性的长度是不是没有
                                                                                        Object length = object.get("finAttLength");
                                                                                        if (length.equals("")){
                                                                            ...
                                                                            mappingObject.put("finAttNameId", "");
                                                                            mappingObject.put("finSortId","");
                                                                            ...
                                                                            mappingObject.put("finAttName", trim2);
                                                                            mappingObject.put("finSortCode",trim3);
                                                            ...
                                                            if (zwCount>intMapping){
                                                                response.setContentType("text/json;charset=utf-8");
                                                                response.getWriter().write("在表"+sheetsName+"中映射"+trim3+"总占位超过"+intMapping+"！");
                                                                FileUtil.delFile(filePath);
                                                                oneLevelSortPass=false;
                                                                break;
                                            ...
                                            for (int j = 0; j < oneLevelMapping.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");
                                                Object attName = o.get("finAttName");
                                                for (int k = 0; k < oneLevelMapping.size(); k++) {
                                                    if (j!=k){
                                                        JSONObject o1 = (JSONObject) oneLevelMapping.get(k);
                                                        Object code1 = o1.get("finSortCode");
                                                        Object attName1 = o1.get("finAttName");
                                                ...
                                                if (trim.length()>0){
                                                    ...
                                                    for (int k = 0; k < sheets.length; k++) {
                                                        ...
                                                        if (name.equals("二级属性表")){
                                                                ...
                                                                for (int z = 1; z < columns; z++) {
                                                                    ...
                                                                    if (sx.equals("属性"+o)){
                                                                        ...
                                                                        if (trim1.length()>0 && trim2.length()>0 && trim3.length()>0){
                                                                            ...
                                                                            String oneSortCode = trim3.substring(0, length0);
                                                                            String twoSortCode = trim3.substring(length0, length0+length1);

                                                                            for (int l = 0; l < twoLevelAttribute.size(); l++) {
                                                                                JSONObject object = (JSONObject) twoLevelAttribute.get(l);
                                                                                Object code = object.get("finSortCode");//二级分类编码
                                                                            ...
                                                                            if (!exist){
                                                                                ...
                                                                                for (int l = 0; l < oneLevelAttribute.size(); l++) {
                                                                                    JSONObject object = (JSONObject) oneLevelAttribute.get(l);
                                                                                    Object code = object.get("finSortCode");
                                                                            ...
                                                                            mappingObject.put("length",trim1);
                                                                            mappingObject.put("finAttName", trim2);
                                                                            mappingObject.put("finSortCode",twoSortCode);
                                                            ...
                                                            if (zwCount>intMapping){
                                                                response.setContentType("text/json;charset=utf-8");
                                                                response.getWriter().write("在表"+sheetsName+"中映射"+trim3+"总占位"+intMapping+"！");
                                                                FileUtil.delFile(filePath);
                                                                oneLevelSortPass=false;
                                                                break;
                                                            ...
                                                            for (int o = 1; o <i1; o++) {
                                                                for (int z = 1; z < columns; z++) {
                                                                    ...
                                                                    if (sx.equals("属性"+o)){
                                                                        ...
                                                                        String oneSortCode = trim3.substring(0, length0);
                                                                        String twoSortCode = trim3.substring(length0, length0+length1);
                                                                        String threeSortCode = trim3.substring(length0+length1, length0+length1+length2);
                                                                        ...
                                                                        if (trim1.length()>0 && trim2.length()>0 && trim3.length()>0){
                                                                            ...
                                                                            for (int l = 0; l < threeLevelAttribute.size(); l++) {
                                                                                ...
                                                                                Object threeLevelCode = object.get("finSortCode");
                                                                            ...
                                                                            if (!exist){
                                                                                ...
                                                                                for (int l = 0; l < twoLevelAttribute.size(); l++) {
                                                                                    JSONObject object = (JSONObject) twoLevelAttribute.get(l);
                                                                                    Object twoLevelCode = object.get("finSortCode");
                                                                                    Object oneLevelCode = object.get("oneLevelCode");
                                                                            ...
                                                                            if (!exist){
                                                                                for (int l = 0; l < oneLevelAttribute.size(); l++) {
                                                                                    JSONObject object = (JSONObject) oneLevelAttribute.get(l);
                                                                                    Object oneLevelCode = object.get("finSortCode");
                                                                            ...
                                                                            mappingObject.put("id","");
                                                                            mappingObject.put("finAttNameId", "");
                                                                            mappingObject.put("finAttSortId","");
                                                                            mappingObject.put("beginLocation",end-(Integer.parseInt(trim1)-1));
                                                                            mappingObject.put("endLocation",end);
                                                                            mappingObject.put("length",trim1);
                                                                            mappingObject.put("finAttName", trim2);
                                                                            mappingObject.put("finSortCode",threeSortCode);
                                                ...
                                                if (trim.length()>0){
                                                    ...
                                                    for (int k = 0; k < sheets.length; k++) {
                                                        ...
                                                        if (name.equals("四级属性表")){
                                                            ...
                                                            for (int o = 1; o <i1; o++) {
                                                                for (int z = 1; z < columns; z++) {
                                                                    ...
                                                                    if (sx.equals("属性"+o)){
                                                                        ...
                                                                        String twoSortCode = trim3.substring(length0, length0+length1);
                                                                        String threeSortCode = trim3.substring(length0+length1, length0+length1+length2);
                                                                        String fourSortCode = trim3.substring(length0+length1+length2,length0+length1+length2+length3);
                                                                        ...
                                                                        if (trim1.length()>0 && trim2.length()>0 && trim3.length()>0){
                                                                            ...
                                                                            for (int l = 0; l < fourLevelAttribute.size(); l++) {
                                                                                ...
                                                                                Object fourLevelCode = object.get("finSortCode");
                                                                            ...
                                                                            mappingObject.put("length",trim1);
                                                                            mappingObject.put("finAttName", trim2);
                                                                            mappingObject.put("finSortCode",fourSortCode);
                                                            ...
                                                            if (zwCount>intMapping){
                                                                response.setContentType("text/json;charset=utf-8");
                                                                response.getWriter().write("在表  "+sheetsName+"  中，映射"+trim3+"总占位"+intMapping+"！");
                                                                FileUtil.delFile(filePath);
                                                                oneLevelSortPass=false;
                                                                break;
...
//                                                }
                                    ...
                                    if (oneLevelSortPass){
                                        ...
                                        List<FinAttributeName> attributeNames = JSONArray.parseArray(ss, FinAttributeName.class);

                                        for (int i = 0; i < attributeNames.size(); i++) {

                                            FinAttributeName attributeName = attributeNames.get(i);

                                            String name = attributeName.getFinAttName();
                                            //查询该公共属性是否存在
                                            boolean b = finAttributeService.selectNameExist(name);
                                            ...
                                            if (!b){
                                                ...
                                                //不存在才进行添加
                                                finAttributeService.addPublic(attributeName);
                                                System.out.println("来了吗");

                                                //查询是否存在物料信息
                                                List<FinProduct> products = finProductService.selectAll();
                                                System.out.println(products);
                                                if (products.size()>0){

                                                    //存在物料信息，给每个物料信息添加新的公共属性信息
                                                    System.out.println(attributeName.getId());

                                                    finAttributeService.afterAddPublicIfFinProductExist(attributeName.getId(), products);
                                                    System.out.println("给物料添加信息了吗");
                                                }
                                                //获取公共属性的id
                                                ...
                                                //存在,查询该公共属性的id
                                                List<FinAttributeName> attributeNames1 = finAttributeService.selectNameIdExcel(name, 0);
                                                id1=attributeNames1.get(0).getId();

                                                //存在，更新单位
                                                attributeName.setId(id1);
                                                finAttributeService.updateUnit(attributeName);
                                            ...
                                            JSONObject object = new JSONObject();
                                            object.put("id","");
                                            object.put("finAttNameId",id1);
                                            object.put("range",0);
                                            object.put("autoCode",0);
                                            String s1 = JSON.toJSONString(object);
                                            FinAttributeFunction attributeFunction = JSON.parseObject(s1, FinAttributeFunction.class);
                                            //查询function是否存在
                                            boolean b1 = finAttributeFunctionService.selectIfExist(id1);

                                            //不存在再进行添加
                                            if (!b1){
                                                //添加function
                                                System.out.println(attributeFunction);
                                                finAttributeFunctionService.add(attributeFunction);
                                            }
                                            ...
                                            for (int j = 0; j < oneLevelMapping.size(); j++) {
                                                ...
                                                if (o1.get("finAttName").equals(name)){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("finAttLength")));
                                            ...
                                            for (int j = 0; j < twoLevelMapping.size(); j++) {
                                                ...
                                                if (o1.get("finAttName").equals(name)){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                                }
                                            }
                                        ...
                                        for (int i = 0; i < oneSort.size(); i++) {
                                            ...
                                            FinSort sort = JSON.parseObject(s, FinSort.class);

                                            //查询分类名是否重复
                                            boolean b = finSortService.selectNameAdd(sort.getFinSortName());
                                            //一级分类编码从零件库和产品库中查询，两个产品库不允许有相同的
                                            boolean b1 = sortService.ifCodeExistAddFromTwoTable(sort.getFinSortCode(), sort.getFinSortLevel(), sort.getParentId());


                                            //先查询编码是否重复
                                            int oneSortId = 0;
                                            boolean b2 = finSortService.selectSortIfExist(sort);//查询分类是否存在
                                            if (b2){
                                                //分类存在，根据编码等级父级也相同查询该分类的id
                                                FinSort sort1 = finSortService.selectSortCode(sort);
                                                ...
                                                if (b){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在一级分类中，分类名："+sort.getFinSortName()+"在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (b1){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在一级分类中分类名："+sort.getFinSortName()+"的分类码在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (!b && !b1){
                                                    //都不相同
                                                    //编码和名称都不重复然后添加
                                                    finSortService.addSortExcel(sort);
                                            ...
                                            for (int j = 0; j < twoSort.size(); j++) {
                                                ...
                                                if (code.equals(o1.get("finSortCode"))){
                                            ...
                                            for (int j = 0; j < oneAttributeName.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");
                                                if (code.equals(sort.getFinSortCode())){
                                                    //是该分类下的属性，给该分类下的属性中的parentId修改为刚才添加的分类id
                                                    o.put("finSortId", oneSortId);
                                                    JSON.toJSONString(o);
                                                    //
                                        ...
                                        for (int i = 0; i < twoSort.size(); i++) {
                                            ...
                                            //查询分类名是否重复
                                            boolean b = finSortService.selectNameAdd(sort.getFinSortName());
                                            boolean b1 = finSortService.ifCodeExistAdd(sort.getFinSortCode(), sort.getFinSortLevel(), sort.getParentId());
                                            int twoSortId=0;
                                            boolean b2 = finSortService.selectSortIfExist(sort);//查询分类是否存在
                                            if (b2){
                                                //分类存在，根据编码等级父级也相同查询该分类的id
                                                ...
                                                if (b){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在二级分类中，分类名："+sort.getFinSortName()+"在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (b1){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在二级分类中分类名："+sort.getFinSortName()+"的分类码在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (!b && !b1){
                                            ...
                                            for (int j = 0; j < threeSort.size(); j++) {
                                                ...
                                                if (code.equals(o1.get("finSortCode")) && o.get("oneLevelCode").equals(o1.get("oneLevelCode"))){
                                            ...
                                            for (int j = 0; j < twoAttributeName.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");
                                                if (code.equals(sort.getFinSortCode()) && o.get("oneLevelCode").equals(o1.get("oneLevelCode"))){
                                                    //是该分类下的属性，给该分类下的属性中的parentId修改为刚才添加的分类id
                                                    o.put("finSortId", twoSortId);
                                                    JSON.toJSONString(o);
                                                    //
                                            ...
                                            for (int j = 0; j < twoMapping.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");//二级编码
                                                if (code.equals(sort.getFinSortCode()) && o.get("oneLevelCode").equals(o1.get("oneLevelCode")) ){
                                                    //是该分类下的映射信息，将映射中的sortId改为刚添加的分类的id
                                                    o.put("finSortId", twoSortId);
                                                    JSON.toJSONString(o);
                                        ...
                                        for (int i = 0; i < threeSort.size(); i++) {
                                            ...
                                            if (b2){
                                                ...
                                                if (b){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在三级分类中，分类名："+sort.getFinSortName()+"的在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (b1){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在三级分类中分类名："+sort.getFinSortName()+"的分类码在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (!b && !b1){
                                            ...
                                            for (int j = 0; j < fourSort.size(); j++) {
                                                ...
                                                if (code.equals(o1.get("finSortCode")) && o1.get("oneLevelCode").equals(o.get("oneLevelCode")) && o1.get("twoLevelCode").equals(o.get("twoLevelCode")) ){
                                            ...
                                            for (int j = 0; j < threeAttributeName.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");
                                                if (code.equals(sort.getFinSortCode()) && o.get("oneLevelCode").equals(o1.get("oneLevelCode")) && o.get("twoLevelCode").equals(o1.get("twoLevelCode")) ){
                                                    //是该分类下的属性，给该分类下的属性中的parentId修改为刚才添加的分类id
                                                    o.put("finSortId", threeSortId);
                                                    JSON.toJSONString(o);
                                                    //
                                        ...
                                        for (int i = 0; i < fourSort.size(); i++) {
                                            ...
                                            if (b2){
                                                ...
                                                if (b){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在四级分类中,分类名："+sort.getFinSortName()+"在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (b1){
                                                    ...
                                                    check=false;
                                                    response.setContentType("text/json;charset=utf-8");
                                                    response.getWriter().write("在四级分类中分类名："+sort.getFinSortName()+"的分类码在数据库中已存在！");
                                                    FileUtil.delFile(filePath);
                                                    break;
                                                }
                                                else if (!b && !b1){
                                            ...
                                            for (int j = 0; j < fourAttributeName.size(); j++) {
                                                ...
                                                Object code = o.get("finSortCode");
                                                if (code.equals(sort.getFinSortCode()) && o.get("oneLevelCode").equals(o1.get("oneLevelCode")) && o.get("twoLevelCode").equals(o1.get("twoLevelCode")) && o.get("threeLevelCode").equals(o1.get("threeLevelCode")) ){
                                                    //是该分类下的属性，给该分类下的属性中的parentId修改为刚才添加的分类id
                                                    o.put("finSortId", fourSortId);
                                                    JSON.toJSONString(o);
                                                    //
                                        ...
                                        for (int i = 0; i < oneAttributeName.size(); i++) {
                                            ...
                                            FinAttributeName attributeName = JSON.parseObject(s, FinAttributeName.class);
                                            Integer finAttLength = attributeName.getFinAttLength();
                                            if (finAttLength == null){
                                                attributeName.setFinAttLength(0);
                                            }
                                            //查询该属性信息是否存在
                                            boolean b = finAttributeService.selectAttNameIfExistExcel(attributeName);
                                            int id1;
                                            if (!b){
                                                //不存在该属性，检测该分类下是否有物料信息存在
                                                int parentId = attributeName.getFinSortId();
                                                List<FinProduct> products = finProductService.selectAllInSort(parentId);
                                                if (products.size()==0){
                                                    //该分类下不存在物料信息，直接添加属性
                                                    finAttributeService.addAttNameExcelAndId(attributeName);
                                                    //获取添加的属性信息id
                                                    id1 = attributeName.getId();
                                                    ...
                                                    for (int l = 0; l < products.size(); l++) {
                                                        JSONObject object1 = new JSONObject();
                                                        FinProduct product1 = products.get(l);

                                                        String s4 = JSON.toJSONString(product1);
                                                        FinProduct product = JSON.parseObject(s4, FinProduct.class);
                                                        int id2 = product.getId();
                                                        object1.put("id", "");
                                                        object1.put("finAttNameId", id1);
                                                        object1.put("finProductId", id2);
                                                        object1.put("finAttContent", "");
                                                ...
                                                //属性信息存在，查询属性信息的id
                                                List<FinAttributeName> attributeNames1 = finAttributeService.selectNameIdExcel(attributeName.getFinAttName(),attributeName.getFinSortId());
                                                id1 = attributeNames1.get(0).getId();
                                            ...
                                            for (int j = 0; j < oneLevelMapping.size(); j++) {
                                                JSONObject o1 = (JSONObject) oneLevelMapping.get(j);
                                                Object code = o1.get("finSortCode");
                                                if (o1.get("finAttName").equals(o.get("finAttBame")) &&code.equals(o.get("finSortCode"))){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                                }
                                            ...
                                            for (int j = 0; j < twoLevelMapping.size(); j++) {
                                                ...
                                                if (o1.get("finAttName").equals(o.get("finAttName")) &&code.equals(o.get("finSortCode"))){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                                }
                                        ...
                                        for (int i = 0; i < twoAttributeName.size(); i++) {
                                            ...
                                            for (int j = 0; j < twoLevelMapping.size(); j++) {
                                                JSONObject o1 = (JSONObject) twoLevelMapping.get(j);
                                                Object code = o1.get("finSortCode");
                                                if (o1.get("finAttName").equals(o.get("finAttName")) &&code.equals(o.get("finSortCode"))&&o1.get("oneLevelCode").equals(o.get("oneLevelCode"))  ){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                                }
                                        ...
                                        for (int i = 0; i < threeAttributeName.size(); i++) {
                                            ...
                                            for (int j = 0; j < threeLevelMapping.size(); j++) {
                                                JSONObject o1 = (JSONObject) threeLevelMapping.get(j);
                                                Object code = o1.get("finSortCode");
                                                if (o1.get("finAttName").equals(o.get("finAttName")) &&code.equals(o.get("finSortCode"))&&o1.get("oneLevelCode").equals(o.get("oneLevelCode")) && o1.get("twoLevelCode").equals(o.get("twoLevelCode"))  ){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                                }
                                        ...
                                        for (int i = 0; i < fourAttributeName.size(); i++) {
                                            ...
                                            for (int j = 0; j < fourLevelMapping.size(); j++) {
                                                JSONObject o1 = (JSONObject) fourLevelMapping.get(j);
                                                Object code = o1.get("finSortCode");
                                                if (o1.get("finAttName").equals(o.get("finAttName")) && code.equals(o.get("finSortCode"))&&o1.get("oneLevelCode").equals(o.get("oneLevelCode")) && o1.get("twoLevelCode").equals(o.get("twoLevelCode")) && o1.get("threeLevelCode").equals(o.get("threeLevelCode"))   ){
                                                    o1.put("finAttNameId", id1);
                                                    attributeName.setFinAttLength(Integer.parseInt((String) o1.get("length")));
                                                    JSON.toJSONString(o1);
                                        ...
                                        if (productValue.size()>0){
                                            ...
                                            List<FinAttributeContent> attributeContents = JSONArray.parseArray(s4, FinAttributeContent.class);
                                            finAttributeService.addAttributeContentExcel(attributeContents);
                                        }
                                        ...
                                        for (int i = 0; i < oneLevelMapping.size(); i++) {
                                            ...
                                            String s = JSON.toJSONString(o);
                                            FinMapping mapping = JSON.parseObject(s, FinMapping.class);

                                            //判断当前分类下是否存在物料信息和映射，如果不存在物料信息和映射信息再进行添加
                                            int sortId = mapping.getFinSortId();
                                            List<FinProduct> products = finProductService.selectAllInSort(sortId);
                                            boolean b = finMappingService.selectMapIfExistExcel(mapping);
                                        ...
                                        if (addMapping.size()>0){
                                            ...
                                            List<FinMapping> mappings = JSONArray.parseArray(s, FinMapping.class);
                                            System.out.println(mappings);
                                            //添加
                                            finMappingService.addMapExcel(mappings);
                                            for (int i = 0; i < mappings.size(); i++) {
                                                FinMapping mapping = mappings.get(i);
                                                int attNameId = mapping.getFinAttNameId();
                                                int length = mapping.getLength();
                                                //更新属性那边的长度
                                                int i1 = finAttributeService.selectIfLengthExist(attNameId);
                                                if (i1==0){
                                                    //长度为0，修改长度
                                        ...
                                        if (updateMapping.size()>0){
                                            List<FinMapping> mappings = JSONArray.parseArray(JSON.toJSONString(updateMapping), FinMapping.class);
                                            //先删除该分类下的映射，然后再重新添加这些映射
                                            finMappingService.deleteMapExcelNextAdd(mappings);
                                            for (int i = 0; i < mappings.size(); i++) {
                                                FinMapping mapping = mappings.get(i);
                                                int attNameId = mapping.getFinAttNameId();
                                                int length = mapping.getLength();
